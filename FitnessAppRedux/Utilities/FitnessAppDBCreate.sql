...
(
    ...
    [Fat] INT NOT NULL,
	PRIMARY KEY CLUSTERED ([Id] ASC),
	CONSTRAINT UC_Meal UNIQUE (Name)
);

INSERT INTO [User] (Username, Height, Weight, Sex , Age, Tdee) VALUES ('BrayPlays', 68, 168, 'M', 2683, NULL), ('Arnold Schwarzenegger', 74, 249, 'M', 3006, NULL), ('Michael Phelps', 76, 198, 'M', 12000, NULL); --12000 during his Olympic run. Wild.
